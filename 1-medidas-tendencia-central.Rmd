...
author:
    name: "[Luis Fernando Amaro Alanis](https://lfamaro.github.io)"
...
> Definición: "La [**mediana** ](https://economipedia.com/definiciones/mediana.html)es un [**estadístico**](https://economipedia.com/definiciones/estadistico.html) de posición central que parte la distribución en dos, es decir, deja la misma cantidad de valores a un lado que a otro. Las fórmulas propuestas no nos darán el valor de la mediana, lo que nos darán será la posición en la que está dentro del conjunto de datos."
...
> Definición: "La [**media** ](https://economipedia.com/definiciones/media.html)es el valor promedio de un conjunto de datos numéricos, calculada como la suma del conjunto de valores dividida entre el número total de valores."
